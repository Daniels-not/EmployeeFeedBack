<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="EmployeeFeedBack._Default" %>
...
<div class="wrapper">
    <div class="bg-white" id="upper-section">
        ...
        <div class="row pt-3">
            ...
            <div class="col-sm-6 mt-sm-0 mt-3" id="dropEmpname">
                <div id="dropdown" class="bg-light rounded border">
                    <p>Employee</p>
        ...
        <div class="rounded">
            ...
            <asp:TextBox ID="txtincome" runat="server" class="form-control bg-light income"></asp:TextBox>
             <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server"
                ...
                ErrorMessage="Income is a required field."
                ForeColor="Red">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-1">
                <div class="d-grid gap-2">
                    <asp:Button ID="register" runat="server" Height="40px" Text="Save request" Width="1457px" class="btn"/>
                </div>
            </div>
        </div>
    </div>
